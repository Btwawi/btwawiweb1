        ...
        <div className="px-4 md:container container absolute right-0 left-0 -bottom-8 sm:-bottom-12 lg:-bottom-16 translate-y-8 sm:translate-y-12 lg:translate-y-16">
          <div className="bg-neutralYellow py-12 px-4 md:px-12 flex flex-col items-center justify-center gap-0">
            ...
            <div className="flex flex-col sm:flex-row text-prussianBlue text-center w-[800px]">
              <div className="flex p-3 flex-col bg-cornsilk sm:w-1/2 items-center ">
                <span className="text-4xl md:text-6xl font-bold">500+</span>
                <span className="text-2xl sm:text-xl lg:text-2xl">
                  Physical attendees
                </span>
              </div>
              <div className="flex p-3 flex-col bg-paleYellow items-center sm:w-1/2">
                <span className="text-4xl md:text-6xl font-bold">300K+</span>
                <span className="text-2xl sm:text-xl lg:text-2xl">
                  Viewers online
                </span>
              </div>
        ...
        <div className="bg-white py-12 px-4 md:px-12 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="w-full md:w-1/2 text-prussianBlue font-aeonik">
            <h2 className="text-2xl md:text-4xl font-semibold">
              <span className="italic font-light">Why</span> Attend Abuja 2.0?
            </h2>
            <p className="mt-4 text-lg md:text-2xl leading-relaxed">
              Abuja 2.0 is your opportunity to learn how to grow your business
              the way Allaah wants. It is a space where you can connect with
              professionals, Islamic finance experts, and fellow entrepreneurs
              who share your values.
            </p>
            <p className="mt-4 text-lg md:text-2xl leading-relaxed">
              You will explore halal investment and funding options that support
              your business goals without compromising your faith. From shopping
              with trusted Muslim vendors to hearing inspiring success stories
              from real business owners, Abuja 2.0 promises to leave you
              informed, motivated, and equipped for purposeful business growth.
            </p>
            <a
              href="#"
