...
const blogArticles = [
  {
    id: 1,
    image: "https://api.builder.io/api/v1/image/assets/TEMP/de9f3093056679c8f24a507647549422f06f5f34?width=800",
    title: "Unlocking Global Opportunities in Halal Markets",
    description: "Explore how the booming halal industry is opening doors for entrepreneurs worldwide. Learn about emerging trends, key markets, and how your business can tap into this growing sector.",
    readTime: "3mins read",
    tags: ["halal", "markets", "global", "opportunities", "business"]
  },
  {
    id: 2,
    image: "https://api.builder.io/api/v1/image/assets/TEMP/cf76e4ca6258062b1201748b1d69b36bdc37a5fd?width=800",
    title: "Navigating Certification: Halal Standards Explained",
    description: "Confused about halal certification? Get clarity on global standards, the certification process, and how it impacts your business's credibility and reach.",
    readTime: "3mins read",
    tags: ["certification", "halal", "standards", "compliance", "business"]
  },
  {
    id: 3,
    image: "https://api.builder.io/api/v1/image/assets/TEMP/c68088ae3629098821988b9aa086aca4a4575c96?width=800",
    title: "Women Entrepreneurs Leading the Halal Revolution",
    description: "Discover inspiring stories of women breaking barriers and driving innovation in the halal business landscape.",
    readTime: "3mins read",
    tags: ["women", "entrepreneurs", "leadership", "innovation", "inspiration"]
  },
  {
    id: 4,
    image: "https://api.builder.io/api/v1/image/assets/TEMP/62d2361729c5285cb9737d2b779b64f0418fdd4c?width=800",
    title: "Tech and Tradition: Digital Transformation in Halal Industries",
    description: "See how technology is reshaping halal businesses—from e-commerce to blockchain—while honoring tradition and values.",
    readTime: "3mins read",
    tags: ["technology", "digital", "transformation", "tradition", "innovation"]
  },
  {
    id: 5,
    image: "https://api.builder.io/api/v1/image/assets/TEMP/38237886408a9703ea5f0f14b60083d70090c3c3?width=800",
    title: "Sustainable Halal Business Practices",
    description: "Learn how to build sustainable business practices that align with Islamic values while contributing to environmental and social responsibility.",
    readTime: "4mins read",
    tags: ["sustainability", "halal", "environment", "ethics", "responsibility"]
  },
  {
    id: 6,
    image: "https://api.builder.io/api/v1/image/assets/TEMP/c68088ae3629098821988b9aa086aca4a4575c96?width=800",
    title: "Building Islamic Financial Literacy",
    description: "Master the fundamentals of Islamic finance and learn how to make shariah-compliant investment decisions for your business growth.",
    readTime: "5mins read",
...
export default function Blog() {
  ...
  const handleReadMore = (articleId: number) => {
    if (articleId === 1) {
      ...
      alert(`Opening article: ${blogArticles.find(a => a.id === articleId)?.title}`);
    }
  };
          ...
          <div className="w-[1240px] h-[290px] bg-[#F2F8FF] mx-auto relative">
            ...
            <div className="absolute left-1/2 top-[77px] transform -translate-x-1/2">
              ...
              <p className="text-btwawi-blue font-aeonik text-2xl font-normal leading-[117%] tracking-[-0.48px] text-center w-[547px]">
                Discover insights, stories, and tips on topics that matter to you. Dive into our latest articles and join the conversation!
              </p>
            </div>
          </div>
          ...
          {filteredArticles.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {filteredArticles.map((article) => (
                <div key={article.id} className="w-full max-w-[400px] h-[573px] bg-[#FFF6E7] relative mx-auto">
                  <img 
                    src={article.image} 
                    alt={article.title}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      >
                        ...
                        <svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M12.9771 4.54684C13.1751 4.34885 13.1751 4.02785 12.9771 3.82987L9.75072 0.603486C9.55273 0.4055 9.23173 0.4055 9.03375 0.603487C8.83576 0.801473 8.83576 1.12247 9.03375 1.32046L11.9016 4.18835L9.03375 7.05625C8.83576 7.25423 8.83576 7.57523 9.03375 7.77322C9.23173 7.97121 9.55273 7.97121 9.75072 7.77322L12.9771 4.54684ZM0.451172 4.18835L0.451172 4.69533L12.6186 4.69533L12.6186 4.18835L12.6186 3.68138L0.451172 3.68138L0.451172 4.18835Z" className="fill-btwawi-blue group-hover:fill-white"/>
                        </svg>
                      </button>
                    </div>
                  </div>
